  ...
  const communities = [
    {
      ...
      description: "Stay updated on new features and see how teams track community conversations.",
    ...
    },
    {
      ...
      description: "Tips, tutorials, and guides for spotting mentions and replying faster across channels.",
