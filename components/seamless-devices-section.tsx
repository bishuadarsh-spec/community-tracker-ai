...
export function SeamlessDevicesSection() {
  ...
  return (
    <section ref={ref} className="py-10 md:py-20 px-4 max-w-6xl mx-auto">
      ...
      >
        <p className="text-muted-foreground font-semibold text-sm mb-4 uppercase tracking-widest">Seamless across devices</p>
        ...
        <div className="grid md:grid-cols-2 gap-8 p-8 md:p-12">
          <div className="flex flex-col justify-center">
            <div className="space-y-4 mb-8">
              <div className="inline-block px-3 py-1 bg-muted rounded-full text-foreground text-sm font-medium w-fit">
                Mobile App
              </div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl h-80 flex items-center justify-center"
          >
